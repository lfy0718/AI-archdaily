...
text = "This is an example sentence.This is an example sentence."
inputs = tokenizer(text, return_tensors='pt')
input_ids = inputs.input_ids.cuda()
attention_mask = inputs.attention_mask.cuda()
# embedding function are copied from model.generate() code
vit_embeds = model.extract_feature(pixel_values)
input_embeds = model.language_model.get_input_embeddings()(input_ids)
print("vit_embeds shape:", vit_embeds.shape)  # torch.Size([13, 256, 896])
print("input_embeds  shape:", input_embeds.shape)  # torch.Size([1, 11, 896])
print("====================")
