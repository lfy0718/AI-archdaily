...
class Qwen2_5VL32B:
    def __init__(
            self,
            model_name: str = "Qwen/Qwen2-VL-32B-Instruct",
    ...
    def embed(self, texts: list[str], images: list[Image.Image], is_query=True, instruction=None, **kwargs):
        ...
        for t, i in zip(texts, images):
            ...
            if i is None:
                ...
                input_str += '<|image_pad|>'  # Qwen2.5 VL uses different image token
...
cache_dir = os.path.join(os.path.dirname(__file__), "checkpoints/Qwen2.5")
logging.info(f"Loading Model Qwen/Qwen2-VL-32B-Instruct from {cache_dir}")
qwen2_5_vl = Qwen2_5VL32B("Qwen/Qwen2-VL-32B-Instruct",
                          cache_dir=cache_dir,
                          device=device,
